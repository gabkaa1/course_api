...
from app.exceptions import UserAlreadyExistsExeption, IncorrectEmailOrPasswordException
...
@router.get('/all')
async def read_users_all(users: Users = Depends(get_current_admin_user)):
